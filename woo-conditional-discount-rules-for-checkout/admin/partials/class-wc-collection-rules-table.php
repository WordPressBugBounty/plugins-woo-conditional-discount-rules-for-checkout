...
/**
 * WC_Collection_Rules_Table class.
 *
 * @extends WP_List_Table
 */
if ( ! class_exists( 'WC_Collection_Rules_Table' ) ) {

  class WC_Collection_Rules_Table extends WP_List_Table {
	...
	public function __construct() {
	  parent::__construct( array(
		'singular' => 'wdpad_collection',
		'plural'   => 'wdpad_collection',
		'ajax'     => false
	  ) );
	...
	public function prepare_items() {
		...
		$args = array(
			'post_type'      => 'wdpad_collection', // Important!
	...
	// Column display callback function
	...
	*/
	...
	public function search_box( $text, $input_id ) {
		...
		<p class="search-box">
			...
			<input type="search" id="<?php echo esc_attr( $input_id ); ?>" name="s" value="<?php _admin_search_query(); ?>" placeholder="<?php esc_html_e( 'Collection title', 'woo-conditional-discount-rules-for-checkout' ); ?>" />
